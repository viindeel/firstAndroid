...
public class Selecciones extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        CardView card3 = vistaSelecciones.findViewById(R.id.seleccion3).findViewById(R.id.tarjeta);
        CardView card4 = vistaSelecciones.findViewById(R.id.seleccion4).findViewById(R.id.tarjeta);

        if (card1 != null) {
            ((ImageView) card1.findViewById(R.id.imagenTarjeta)).setImageResource(R.drawable.argentina);
        ...
        if (card2 != null) {
            ((ImageView) card2.findViewById(R.id.imagenTarjeta)).setImageResource(R.drawable.finlandia);
        ...
        if (card3 != null) {
            ((ImageView) card3.findViewById(R.id.imagenTarjeta)).setImageResource(R.drawable.gales);
        ...
        if (card4 != null) {
            ((ImageView) card4.findViewById(R.id.imagenTarjeta)).setImageResource(R.drawable.paisesbajos);
